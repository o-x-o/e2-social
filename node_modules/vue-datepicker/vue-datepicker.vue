    ...
    <div class="cov-vue-date">
        <div class="datepickbox">
            <!--<input type="text" title="input date" class="cov-datepicker" readonly="readonly"-->
                   ...
                   <!--@foucus="showCheck" :style="option.inputStyle ? option.inputStyle : {}" style="display: none;"/>-->
        </div>
        <div class="datepicker-overlay" v-if="showInfo.check" @click="dismiss($event)"
             v-bind:style="{'background' : option.overlayOpacity? 'rgba(0,0,0,'+option.overlayOpacity+')' : 'rgba(0,0,0,0.5)','left':location.x+'px','top':location.y+'px'}">
            <div class="cov-date-body" :style="{'background-color': option.color ? option.color.header : '#3f51b5'}">
                ...
                <div class="button-box">
                    <span @click="cloasPick">{{option.buttons? option.buttons.cancel : 'Cancel' }}</span>
    ...
    export default{
        ...
        methods: {
            ...
            showCheck(ev) {
                ...
                this.location={x:ev.clientX,y:ev.clientY+20};
